...
my_priors <- c(
  ...
  # We are looking at RT which I have experienced to generally be in the range of 400
  # to 1000 ms. I thus guess the mean to be about 700 or ~6.5 as log. Attemting to 
  # make a wide normal distribution I set the standard deviation to be 2. I plot this
