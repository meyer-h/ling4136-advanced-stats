...
plogis(c(
  -0.02359,               # (Intercept)
  (-0.02359 + 0.52332)    # correct_voicingvoiceless
))
```
...
plot_predictions <- 
  ...
  scale_y_continuous(
    limits = c(0, 1) # Important, as plot shows probability
    )+
  labs(
    x = "Correct voicing",
    y = "Predicted probability of choosing voiced",
    title = "Predicted probability of choosing voiced based on correct voicing",
