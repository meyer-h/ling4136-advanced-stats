...
plogis(-0.02359) # (Intercept)
plogis(0.52332) # correct_voicingvoiceless
```
...
Further, it predicts that the logarithmic odds of choosing *voiced* when the stimuli was *voiceless* was \~0.523. Probability-wise this predicts this choice to happen about 63% of the time. P value?
