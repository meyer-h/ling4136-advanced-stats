...
# Mean is 133, which is the average distance between two random points at an a4 paper
# SD is 70 as that is the SD for a random distribution of points
# Minimum xlim is 0 (can't be smaller than no distance)
# Maximum xlim is 363.9 (can't be larger than the diagonal of A4)
plot_normal(mean = 133, sd = 70) + 
  xlim(0, 363.9)
